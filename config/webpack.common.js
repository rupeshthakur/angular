...
const METADATA = {
  title: 'Angular2 Webpack Starter by Rupesh @ Modified from AngularClass',
  baseUrl: '/',
  ...
  return {
    ...
    entry: {
      'idc': [
		...
		// './src/assets/inspinia/js/inspinia.js',
		// './src/assets/idc.js',
		//'./src/assets/inspi/lib/inspinia.js',
		],
    ...
    plugins: [
      ...
      new ScriptExtHtmlWebpackPlugin({
        sync: /idc|polyfill|vendor/,
        defaultAttribute: 'async',
        preload: [/idc|polyfill|vendor|main/],
        prefetch: [/chunk/]
      }),
